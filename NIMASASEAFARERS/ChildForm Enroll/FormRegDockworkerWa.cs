...
{
    public partial class FormRegDockworkerWa : UserControl
    {
        public FormRegDockworkerWa()
        {
            InitializeComponent();
        }
        ...
        private void comboQual_SelectedIndexChanged(object sender, EventArgs e)
        {
            comboQual.Items.IndexOf("string");
        }
        ...
        private void FormRegDockworkerWa_Load(object sender, EventArgs e)
        {
