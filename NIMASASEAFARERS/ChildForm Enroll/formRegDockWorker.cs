...
namespace NIMASASEAFARERS
{
    ...
    public partial class formRegDockWorker : UserControl
    {
        ...
        private void formRegDockWorker_Load(object sender, EventArgs e)
        {
        ...
        private void textNIN_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        {
            {
                ...
                {
                    comboBoxGender.Text = comboOrigin.SelectedText;
                }
            }
        }
