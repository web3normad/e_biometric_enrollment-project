...
{
    public partial class FormRegDockworkerCal : UserControl
    {
        public FormRegDockworkerCal()
        {
            InitializeComponent();
        }
        #region Reser fields
        ...
        private void textBoxCnic_Load_1(object sender, EventArgs e)
        {
            DockworkerId();
        }
        ...
        private void FormRegDockworkerCal_Load(object sender, EventArgs e)
        {
