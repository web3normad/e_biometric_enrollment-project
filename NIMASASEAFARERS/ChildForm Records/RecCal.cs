...
{
    public partial class RecCal : UserControl
    {
        public RecCal()
        {
            InitializeComponent();
        ...
        {
            dataGridCal.SelectAll();
            DataObject copydata = dataGridCal.GetClipboardContent();
        ...
        {
            EditDockworkerCal edr = new EditDockworkerCal();
            MainControlClass.showControl(edr, Content);
        }
        ...
        private void RecCal_Load(object sender, EventArgs e)
        {
            gridView();
        }
