...
{
    public partial class RecPh : UserControl
    {
        public RecPh()
        {
            InitializeComponent();
        ...
        {
            dataGridPh.SelectAll();
            DataObject copydata = dataGridPh.GetClipboardContent();
        ...
        {
            EditDockWorkerPh edp = new EditDockWorkerPh();
            MainControlClass.showControl(edp, Content);
        }
        ...
        private void RecPh_Load(object sender, EventArgs e)
        {
            gridView();
        }
    }
