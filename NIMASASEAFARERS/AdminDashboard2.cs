...
namespace NIMASASEAFARERS
{
    ...
    public partial class AdminDashboard2 : Form
    {
        ...
        private void DisableButton()
        {
            ...
            {
                currentBtn.BackColor = Color.FromArgb(249, 249, 249);
                currentBtn.ForeColor = Color.LightSeaGreen;
                currentBtn.TextAlign = ContentAlignment.MiddleLeft;
                currentBtn.IconColor = Color.LightSeaGreen;
        ...
        private void btnRSeafarer_Click(object sender, EventArgs e)
        {
        ...
        private void btnRDockworker_Click(object sender, EventArgs e)
        {
        ...
        private void AdminDashboard2_MouseDown(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
            SendMessage(this.Handle, 0x112, 0xf012, 0);
        }

        private void panelNav_MouseDown_1(object sender, MouseEventArgs e)
        {
            ReleaseCapture();
            SendMessage(this.Handle, 0x112, 0xf012, 0);
        }
        ...
        private void btnLogoout_Click(object sender, EventArgs e)
        {
            UserLogin formUser = new UserLogin();
            formUser.Show();
            this.Hide();
        }
